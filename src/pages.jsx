...
function HeroSection({ onNavigate }) {
  ...
  // Subtle ticker for animated elements
  React.useEffect(() => {
  ...
  return (
    <section style={{ position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'center', overflow: 'hidden', background: '#080808' }}>
      ...
      {/* Sweeping gradient orbs — mouse-tracked */}
      <div style={{
      ...
      {/* Floating abstract data-viz decoration */}
      ...
      {/* CONTENT */}
      <div style={{ position: 'relative', zIndex: 10, maxWidth: 1200, margin: '0 auto', padding: '110px 32px 72px', width: '100%' }}>

        {/* TOP ROW: text left, photo right — aligned to top */}
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: 64, alignItems: 'flex-start', marginBottom: 56 }}>
          ...
          <div>
            ...
            <div className="fade-up" style={{ animationDelay: '0.15s' }}>
              <h1 className="syne" style={{ fontSize: 'clamp(46px, 6.5vw, 88px)', fontWeight: 900, letterSpacing: '-0.04em', lineHeight: 0.95, marginBottom: 0 }}>
            ...
            <div className="fade-up" style={{ animationDelay: '0.3s', marginTop: 36 }}>
              <p style={{ fontSize: 'clamp(14px,1.4vw,16px)', color: 'rgba(242,240,235,0.45)', lineHeight: 1.8, maxWidth: 460, marginBottom: 28 }}>
          ...
          <div className="fade-up" style={{ animationDelay: '0.2s', position: 'relative' }}>
            ...
            <div style={{ position: 'relative', zIndex: 2, width: '100%', height: 420, borderRadius: 18, overflow: 'hidden' }}>
        ...
        {/* BOTTOM ROW: stats + stack — full width */}
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.07)', paddingTop: 36 }}>
          {/* Stats */}
          <div className="fade-up" style={{ animationDelay: '0.4s', display: 'flex', justifyContent: 'space-between', marginBottom: 28 }}>
            {[{ n: '3', suffix: '+', label: 'Projects' }, { n: '93', suffix: '%', label: 'CV F1 Score' }, { n: '1.57', suffix: 'M', prefix: '$', label: 'Revenue Analyzed' }].map((s, i) => (
              <div key={s.label} style={{ display: 'flex', flexDirection: 'column', gap: 4, paddingRight: i < 2 ? 48 : 0, borderRight: i < 2 ? '1px solid rgba(255,255,255,0.06)' : 'none' }}>
                <div className="syne" style={{ fontSize: 32, fontWeight: 900, letterSpacing: '-0.04em', lineHeight: 1, background: 'linear-gradient(135deg,#10b981,#f59e0b)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
        ...
        <AnimateIn>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 64 }}>
            <div>
              ...
              <h2 className="syne" style={{ fontSize: 'clamp(32px,5vw,52px)', fontWeight: 800, letterSpacing: '-0.04em', color: '#f2f0eb', lineHeight: 1.1 }}>
...
function AboutHomeSection({ onNavigate }) {
  return (
    <section style={{ background: '#0d0d0d', padding: '120px 32px', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
        <AnimateIn>
          <div>
            <div className="sect-label" style={{ marginBottom: 20 }}>About</div>
            <h2 className="syne" style={{ fontSize: 'clamp(32px,4vw,48px)', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.1, marginBottom: 24 }}>
  ...
  return (
    <section style={{ background: '#080808', padding: '120px 32px' }}>
      <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative' }}>
        ...
        <div style={{ position: 'relative', textAlign: 'center', padding: '80px 48px', borderRadius: 24, border: '1px solid rgba(16,185,129,0.15)', background: 'linear-gradient(135deg, rgba(16,185,129,0.04) 0%, rgba(245,158,11,0.04) 100%)' }}>
          {/* Corner accents */}
          ...
          <AnimateIn>
            ...
            <h2 className="syne" style={{ fontSize: 'clamp(32px,5vw,56px)', fontWeight: 900, letterSpacing: '-0.04em', color: '#f2f0eb', marginBottom: 16, lineHeight: 1.1 }}>
              Let's build something<br /><span className="grad-text">that matters.</span>
            </h2>
            <p style={{ fontSize: 16, color: 'rgba(242,240,235,0.4)', maxWidth: 480, margin: '0 auto 40px', lineHeight: 1.75 }}>
...
function ProjectsPage({ onNavigate }) {
  ...
  return (
    <div className="page" style={{ paddingTop: 64, background: '#080808', minHeight: '100vh' }}>
      {/* Hero */}
      <div style={{ position: 'relative', padding: '80px 32px 64px', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <h1 className="syne" style={{ fontSize: 'clamp(40px,7vw,80px)', fontWeight: 900, letterSpacing: '-0.04em', color: '#f2f0eb', marginBottom: 16, lineHeight: 1 }}>
      ...
      {/* Grid */}
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '32px 32px 96px', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20 }}>
        {projects.map((p, i) =>
        <AnimateIn key={p.id} delay={i * 0.1}>
...
function ProjectDetailPage({ projectId, onNavigate }) {
  ...
  return (
    <div className="page" style={{ paddingTop: 64, background: '#080808', minHeight: '100vh' }}>
      ...
      {/* Hero */}
      <div style={{ position: 'relative', padding: '72px 32px 56px', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <button onClick={() => onNavigate('projects')} style={{ display: 'inline-flex', alignItems: 'center', gap: 8, marginBottom: 28, padding: '7px 16px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.04)', color: 'rgba(242,240,235,0.4)', fontSize: 13, fontWeight: 500, cursor: 'pointer', transition: 'all 0.2s' }}
          ...
          <h1 className="syne" style={{ fontSize: 'clamp(28px,5vw,56px)', fontWeight: 900, letterSpacing: '-0.04em', color: '#f2f0eb', marginBottom: 16, lineHeight: 1.05 }}>{p.title}</h1>
          <p style={{ fontSize: 16, color: 'rgba(242,240,235,0.4)', maxWidth: 640, lineHeight: 1.7, marginBottom: 28 }}>{p.description}</p>
      ...
      {/* KPIs */}
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)', padding: '48px 32px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', display: 'grid', gridTemplateColumns: `repeat(${p.kpis.length}, 1fr)`, gap: 1 }}>
          {p.kpis.map((kpi, i) =>
          <AnimateIn key={kpi.label} delay={i * 0.08}>
              <div style={{ textAlign: 'center', padding: '24px', borderRight: i < p.kpis.length - 1 ? '1px solid rgba(255,255,255,0.06)' : 'none' }}>
                <div className="syne" style={{ fontSize: 'clamp(28px,4vw,42px)', fontWeight: 900, letterSpacing: '-0.04em', color: p.color, lineHeight: 1, marginBottom: 8 }}>{kpi.value}</div>
      ...
      filter(Boolean).map((sec, i, arr) =>
      <div key={sec.title} style={{ padding: '56px 32px', borderTop: '1px solid rgba(255,255,255,0.05)', background: i % 2 === 0 ? '#080808' : '#0c0c0c' }}>
          <div style={{ maxWidth: 900, margin: '0 auto' }}>
            <AnimateIn>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
                <div style={{ width: 40, height: 40, borderRadius: 11, background: sec.color + '15', color: sec.color, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <sec.icon size={18} />
                </div>
                <h2 className="syne" style={{ fontSize: 'clamp(20px,3vw,28px)', fontWeight: 800, letterSpacing: '-0.03em', color: '#f2f0eb' }}>{sec.title}</h2>
              </div>
              <p style={{ fontSize: 15.5, color: 'rgba(242,240,235,0.45)', lineHeight: 1.85 }}>{sec.text}</p>
            </AnimateIn>
          </div>
        </div>
      )}
      ...
      {/* Results */}
      <div style={{ padding: '56px 32px', borderTop: '1px solid rgba(255,255,255,0.05)', background: '#0c0c0c' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <AnimateIn>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 28 }}>
              <div style={{ width: 40, height: 40, borderRadius: 11, background: '#10b98115', color: '#10b981', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Icon.TrendingUp size={18} />
              </div>
              <h2 className="syne" style={{ fontSize: 'clamp(20px,3vw,28px)', fontWeight: 800, letterSpacing: '-0.03em', color: '#f2f0eb' }}>Results & Impact</h2>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 32 }}>
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 12, padding: '14px 18px', borderRadius: 10, background: '#141414', border: '1px solid rgba(255,255,255,0.06)' }}>
                  ...
                  <span style={{ fontSize: 14.5, color: 'rgba(242,240,235,0.55)', lineHeight: 1.65 }}>{r}</span>
                </div>
              )}
            </div>
            {/* Impact box */}
            <div style={{ padding: '28px', borderRadius: 14, background: 'linear-gradient(135deg, rgba(16,185,129,0.06), rgba(245,158,11,0.06))', border: `1px solid ${p.color}25` }}>
              ...
              <p style={{ fontSize: 15, color: 'rgba(242,240,235,0.5)', lineHeight: 1.8 }}>{p.impact}</p>
            </div>
          </AnimateIn>
        </div>
      </div>
      ...
      {/* Visuals gallery */}
      {p.visuals &&
      <div style={{ padding: '56px 32px', borderTop: '1px solid rgba(255,255,255,0.05)', background: '#080808' }}>
      ...
      {/* Back CTA */}
      <div style={{ padding: '72px 32px', textAlign: 'center', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <AnimateIn>
          <h2 className="syne" style={{ fontSize: 32, fontWeight: 800, letterSpacing: '-0.03em', marginBottom: 12, color: '#f2f0eb' }}>Explore More Projects</h2>
    ...
    <div className="page" style={{ paddingTop: 64, background: '#080808', minHeight: '100vh' }}>
      ...
      <div style={{ position: 'relative', padding: '80px 32px 64px', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontSize: 17, color: 'rgba(242,240,235,0.4)', maxWidth: 520, lineHeight: 1.75, marginBottom: 28 }}>
      ...
      {/* Who I Am */}
      <div style={{ padding: '72px 32px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '3fr 2fr', gap: 72, alignItems: 'start' }}>
          <AnimateIn>
            <div className="sect-label" style={{ marginBottom: 20 }}>Who I Am</div>
            <p style={{ fontSize: 16, color: 'rgba(242,240,235,0.5)', lineHeight: 1.85, marginBottom: 16 }}>
            ...
            <p style={{ fontSize: 16, color: 'rgba(242,240,235,0.35)', lineHeight: 1.85, marginBottom: 28 }}>
      ...
      {/* Journey */}
      <div style={{ padding: '72px 32px', borderTop: '1px solid rgba(255,255,255,0.05)', background: '#0c0c0c' }}>
            ...
            {skills.map((g, i) => {
              ...
              return (
                <AnimateIn key={g.label} delay={i * 0.08}>
                  <div style={{ padding: '28px 24px', borderRadius: 16, background: '#111', border: '1px solid rgba(255,255,255,0.06)', transition: 'all 0.3s ease' }}
                  ...
                  onMouseLeave={(e) => {e.currentTarget.style.borderColor = 'rgba(255,255,255,0.06)';e.currentTarget.style.background = '#111';e.currentTarget.style.transform = 'none';}}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                      {g.skills.map((s) =>
                      <span key={s} style={{ padding: '4px 10px', borderRadius: 6, fontSize: 11.5, fontWeight: 500, background: 'rgba(255,255,255,0.04)', color: 'rgba(242,240,235,0.4)', border: '1px solid rgba(255,255,255,0.07)', transition: 'all 0.2s' }}>{s}</span>
                      )}
                    </div>
                  </div>
                </AnimateIn>);
      ...
      <div style={{ padding: '72px 32px', borderTop: '1px solid rgba(255,255,255,0.05)', background: '#0c0c0c' }}>
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          <AnimateIn>
            <div style={{ padding: '40px', borderRadius: 20, border: '1px solid rgba(16,185,129,0.2)', background: 'linear-gradient(135deg, rgba(16,185,129,0.05), rgba(245,158,11,0.05))' }}>
              ...
              <p style={{ fontSize: 15.5, color: 'rgba(242,240,235,0.4)', lineHeight: 1.8, marginBottom: 28 }}>
    ...
    <div className="page" style={{ paddingTop: 64, background: '#080808', minHeight: '100vh' }}>
      ...
      <div style={{ position: 'relative', padding: '80px 32px 64px', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontSize: 16, color: 'rgba(242,240,235,0.35)', maxWidth: 460, lineHeight: 1.75 }}>
      ...
      {/* Content */}
      <div style={{ padding: '48px 32px 96px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth: 1000, margin: '0 auto', display: 'grid', gridTemplateColumns: '2fr 3fr', gap: 64, alignItems: 'start' }}>
          ...
          <AnimateIn>
            <div>
              ...
              <p style={{ fontSize: 14, color: 'rgba(242,240,235,0.35)', lineHeight: 1.75, marginBottom: 36 }}>
              ...
              {/* Availability */}
              <div style={{ marginTop: 28, padding: '16px 18px', borderRadius: 12, background: 'rgba(16,185,129,0.06)', border: '1px solid rgba(16,185,129,0.2)' }}>
